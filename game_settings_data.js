...
window.SCENARIOBUILD_IMPORTED_SETTINGS_DATA = {
  ...
  "achievements": [
    ...
    {
      "id": "achievement_1789462600003_3",
      "name": "見習いを卒業",
      "description": "職業レベルが10になる。",
      "hidden": false,
      "conditionType": "classLevel",
      "conditionValue": 10,
      "classId": "",
      ...
      "rewardExp": 500,
      "rewardGold": 800,
      "rewardItemId": "potion_004",
      "rewardItemQty": 2
    },
    {
      "id": "achievement_1789462600004_4",
      "name": "歴戦の戦士",
      "description": "「戦士」の職業レベルが10になる。",
      "hidden": false,
      "conditionType": "classLevel",
      "conditionValue": 10,
      "classId": "戦士",
      ...
      "rewardExp": 500,
      "rewardGold": 800,
      "rewardItemId": "weapon_004",
      "rewardItemQty": 1
    },
    {
      "id": "achievement_1789462600005_5",
      "name": "全能への道",
      "description": "「全能士」の職業レベルが30になる。",
      "hidden": false,
      "conditionType": "classLevel",
      "conditionValue": 30,
      "classId": "全能士",
      ...
      "rewardExp": 3000,
      "rewardGold": 5000,
      "rewardItemId": "armor_004",
      "rewardItemQty": 1
    },
    {
      "id": "achievement_1789462600006_6",
      "name": "性なる目覚め",
      "description": "「性騎士」に転職する。",
      "hidden": false,
    ...
    {
      "id": "achievement_1789462600007_7",
      "name": "目利きの証",
      "description": "「お宝鑑定団」に転職する。",
      "hidden": false,
      "conditionType": "classUnlocked",
      "conditionValue": 1,
      "classId": "お宝鑑定団",
    ...
    {
      "id": "achievement_1789462600008_8",
      "name": "魔法少女爆誕",
      "description": "「魔法少女」に転職する。",
      "hidden": false,
      "conditionType": "classUnlocked",
      "conditionValue": 1,
      "classId": "魔法少女",
    ...
    {
      "id": "achievement_1789462600010_10",
      "name": "闇に生きる者",
      "description": "「暗殺者」に転職する。",
      "hidden": false,
      "conditionType": "classUnlocked",
      "conditionValue": 1,
      "classId": "暗殺者",
    ...
    {
      "id": "achievement_1789462600011_11",
      "name": "陰の力に目覚めて",
      "description": "「陰騎士」に転職する。",
      "hidden": false,
      "conditionType": "classUnlocked",
      "conditionValue": 1,
      "classId": "陰騎士",
    ...
    {
      "id": "achievement_1789462600012_12",
      "name": "全てを極めし者",
      "description": "「全能士」に転職する。",
      "hidden": false,
      "conditionType": "classUnlocked",
      "conditionValue": 1,
      "classId": "全能士",
    ...
    },
    {
      ...
      "rewardExp": 1000,
      "rewardGold": 1500,
      "rewardItemId": "potion_003",
      "rewardItemQty": 3
    },
    {
      "id": "achievement_1789462600017_17",
      "name": "一撃入魂",
      "description": "累計ダメージ量が10000に達する。",
      "hidden": false,
      "conditionType": "totalDamageDealt",
    ...
    {
      "id": "achievement_1789462600018_18",
      "name": "癒しの手",
      "description": "累計回復量が5000に達する。",
      "hidden": false,
      "conditionType": "totalHealingDone",
      "conditionValue": 5000,
      "classId": "",
      "monsterKey": "",
      "areaId": "",
    ...
    },
    {
      ...
      "rewardExp": 400,
      "rewardGold": 500,
      "rewardItemId": "herb_001",
      "rewardItemQty": 3
    },
    {
      "id": "achievement_1789462600020_20",
      "name": "スライムハンター",
    ...
    {
      "id": "achievement_1789462600021_21",
      "name": "ゴブリン退治屋",
      "description": "ゴブリンを30体倒す。",
      "hidden": false,
      "conditionType": "enemyKillsSpecific",
      "conditionValue": 30,
      "classId": "",
    ...
    },
    {
      ...
      "conditionValue": 1,
      "classId": "",
      "monsterKey": "boss_1788741265160_1",
      "areaId": "",
      "flagName": "",
      "varName": "",
      "rewardExp": 1200,
    ...
    {
      "id": "achievement_1789462600025_25",
      "name": "魔物図鑑：はじめの一歩",
      "description": "登録されている全ての魔物を、それぞれ3体以上倒す。",
      "hidden": false,
      "conditionType": "enemyKillsAllTypes",
      "conditionValue": 3,
      "classId": "",
      "monsterKey": "",
      "areaId": "",
    ...
    {
      "id": "achievement_1789462600026_26",
      "name": "百戦錬磨",
      "description": "累計討伐数が100体に達する。",
      "hidden": false,
      "conditionType": "totalKillCount",
      "conditionValue": 100,
      "classId": "",
    ...
    {
      "id": "achievement_1789462600030_30",
      "name": "最果ての平野へ",
      "description": "「ガヂル平野(推奨Lv60)」を解放する。",
      "hidden": false,
      "conditionType": "areaUnlocked",
      "conditionValue": 1,
      "classId": "",
      "monsterKey": "",
      "areaId": "builtinarea_1786777141727_85",
      "flagName": "",
      "varName": "",
      "rewardExp": 1000,
      "rewardGold": 1200,
  ...
  "tutorials": [
    ...
    {
      "id": "tutorial_1789462700001_1",
      "category": "基本",
      "title": "職業と転職について",
      "body": "役場・役所では陳を払うことで職業を変更できます。一度でもなったことがある職業は、そのときのレベルのまま再開でき、経験値は職業ごとに別々に管理されます。武器の中には、装備できる職業が決まっているものもあります。"
    },
    {
      "id": "tutorial_1789462700002_2",
      "category": "基本",
      "title": "名声度と冒険者ランクについて",
      "body": "名声度はクエストをクリアすると貯まる隠しステータスで、一定量たまると冒険者ランクが上がり、受けられる依頼の幅が広がります。ただしCランク以上は名声度が足りているだけでは上がらず、「試練の祭殿」でそのランクの試練をクリアする必要があります。"
    },
    {
      "id": "tutorial_1789462700003_3",
      "category": "基本",
      "title": "装備について",
      "body": "武器・胴・盾の3つの部位に装備を付け替えられます。防具の最大HPボーナスは装備した瞬間に反映され、外すと元に戻ります。職業によっては装備できる武器の種類が決まっていたり、特定の職業でなければ装備できないアイテムもあります。"
    },
    {
      "id": "tutorial_1789462700004_4",
      "category": "基本",
      "title": "仲間について",
      "body": "仲間は話の進行にあわせてパーティに加わり、主人公とは別に自分だけのレベル・経験値・HP/SPを持って育っていきます。仲間にも武器・胴・盾を個別に装備させられます。話の都合で一時的に離脱しても、レベルや装備はそのまま保存され、再加入すれば続きから活躍してくれます。"
    },
    {
      "id": "tutorial_1789462700005_5",
      "category": "基本",
      "title": "ログインボーナスについて",
      "body": "セーブデータをロードした日（端末の日付基準）に、1日1回だけ受け取れます。前回受け取った翌日にロードすると連続日数が1日進み、7日目の次はまた1日目に戻ってループします。間が空いてしまうと、連続日数は1日目からやり直しになります。"
    },
    {
      "id": "tutorial_1789462700006_6",
      "category": "基本",
      "title": "実績について",
      "body": "便利タブの「実績」から、達成した実績の一覧や達成条件・報酬を確認できます。隠し実績は、達成するまで一覧に存在ごと表示されません。それ以外の実績は一覧に出ますが、達成するまで名前・説明は「？？？」のままです。"
    },
    {
      "id": "tutorial_1789462700007_7",
      "category": "町",
      "title": "施設について",
      "body": "拠点には宿屋・役場（役所）・道具屋などの店・鍛冶屋・素材合成屋・酒場といった、いろいろな施設があります。宿屋ではHP/SPの全回復や眠気・疲労度の回復、役場では職業の変更、酒場ではクエスト掲示板の閲覧ができます。施設ごとに扱っている物や値段が違うので、いろんな拠点を回ってみるのもおすすめです。"
    },
    {
      "id": "tutorial_1789462700008_8",
      "category": "町",
      "title": "マップでの移動について",
      "body": "町の「冒険する」から、丸と線でつながったマップの上を移動して行き先を選べます。まだ何も分かっていない場所は「？」として表示され、実際に足を運んだり話が進んだりすると少しずつ判明していきます。"
    },
    {
      "id": "tutorial_1789462700009_9",
      "category": "鍛冶屋・合成屋",
      "title": "鍛冶屋・素材合成屋について",
      "body": "鍛冶屋や素材合成屋では、素材と陳（お金）を使ってアイテムを作ったり、今持っている武器・防具を強化したりできます。強化の場合は、素材に加えて元になる装備そのものも1つ消費するので、必要な物は事前に集めておきましょう。"
    },
    {
      "id": "tutorial_1789462700010_10",
      "category": "鍛冶屋・合成屋",
      "title": "錆びついた装備について",
      "body": "「錆びたシリーズ」の武器・防具は、鑑定するまで本当の性能が分かりません。低ランクのことが多いですが、ごく低い確率でA〜Xランクの当たりに化けることもあります。錆取り屋にお金を払えば、手持ちの錆びたシリーズのステータスを振り直してもらうことも可能です。"
    },
    {
      "id": "tutorial_1789462700011_11",
      "category": "お宝鑑定団",
      "title": "「なんでも鑑定」について",
      "body": "「お宝鑑定団」だけが使える固有スキル「なんでも鑑定」では、アイテムの値段を予想してからSPを消費して鑑定します。鑑定できるのは自分の冒険者ランク+1までのアイテムまで。「錆びたシリーズ」を鑑定すると、本当のステータスが判明するだけでなく、まれにレアなランクへ化けることもあります。"
    },
    {
      "id": "tutorial_1789462700012_12",
      "category": "戦闘",
      "title": "戦闘コマンドについて",
      "body": "戦闘中は「たたかう」「スキル」「道具」「こうどう」から行動を選べます。スキルはSPを消費するかわりに、攻撃・回復・バフなどさまざまな効果を持っています。「こうどう」からは「奇声をあげる」や「逃げる」といった特殊な行動が選べます。"
    },
    {
      "id": "tutorial_1789462700013_13",
      "category": "戦闘",
      "title": "状態異常について",
      "body": "戦闘中は、スタンや毒、火傷など、行動やHPを妨げる状態異常を受けることがあります。特技や敵によって、かかる状態異常の種類・確率・持続ターンはさまざまです。特定のスキルや道具には、かかってしまった状態異常を治す効果を持つものもあります。"
    },
    {
      "id": "tutorial_1789462700014_14",
      "category": "戦闘",
      "title": "状態変化（バフ）について",
      "body": "戦闘中は、攻撃力上昇や継続回復など、一定ターンの間だけ効果が続く状態変化（バフ）を自分や味方にかけられることがあります。無敵や不屈のように、一時的に致命的な一撃をしのぐための強力なものもあります。"
    },
    {
      "id": "tutorial_1789462700015_15",
      "category": "戦闘",
      "title": "倒す・見逃すで変わることについて",
      "body": "敵を倒すと経験値を満額もらえるうえ、アイテムをドロップすることがあります。見逃すと経験値は半分になりドロップもありませんが、そのぶん好感度が上がります。累計討伐数などの実績は見逃した敵にはカウントされませんが、クエストの討伐系の進捗は倒しても見逃しても進みます。"
    }
  ],
  "classStats": {
    "全能士": {
